'''
Selenium Docs: https://github.com/SeleniumHQ/selenium
Selenium Drivers: https://www.selenium.dev/selenium/docs/api/py/#drivers
MAC OS: xattr -d com.apple.quarantine PATH_TO_chromedriver 
Examples
'''
